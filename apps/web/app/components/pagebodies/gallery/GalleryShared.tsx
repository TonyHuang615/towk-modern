...
// Classic body + shared fallback. Identical albums/data/i18n keys to every other
// Gallery body; only the grid layout & visual treatment differ across designs.
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export default function GalleryShared({ content }: { content: Record<string, any> }) {

...
// Classic body + shared fallback. Identical content/data/links to every other
// About body; only the layout differs across designs.
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export default function AboutShared({ content }: { content: Record<string, any> }) {
      ...
      <section className="py-16 bg-foreground/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-foreground/70">{t("valuesSubtitle")}</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            >
              <div>
                ...
                <p className="text-sm text-foreground/60 mt-1">{t("structureDesc")}</p>
              </div>
            ...
            >
              <div>
                ...
                <p className="text-sm text-foreground/60 mt-1">{t("boardDesc")}</p>
              </div>
              <ArrowRight className="w-5 h-5 text-foreground/30 group-hover:text-primary group-hover:translate-x-1 transition-all" />
            </Link>
          </div>
          ...
          <div className="space-y-4">
            {milestones
              ...
              .map((item, index) => (
                ...
                >
                  <span className="text-xl font-bold text-primary/70 w-16 shrink-0">
                    {item.year}
                  </span>

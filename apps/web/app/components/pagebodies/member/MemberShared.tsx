...
// Classic — Member profile. Verbatim original body (loading / unauth / auth),
// returning inner content only; the dispatcher provides the single DesignShell.
export default function MemberShared() {

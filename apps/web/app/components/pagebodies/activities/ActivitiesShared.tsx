...
import { Music, Briefcase, Users, Sparkles, ArrowRight } from "lucide-react";
import Link from "next/link";
import { useTranslations } from "next-intl";

// Classic body + shared fallback. Identical content/data/links to every other
// Activities body; only the layout differs across designs.
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export default function ActivitiesShared({ content }: { content: Record<string, any> }) {
            ...
            {items.map((activity: any, index: number) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-8">
                  ...
                  <p className="text-white/75 mb-4">{activity.description}</p>
                  <Link

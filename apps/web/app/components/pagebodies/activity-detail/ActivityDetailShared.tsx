...
// Classic body + shared fallback for the activity detail page. Self-sources the
// activity by slug; identical content/data/links to every other detail body —
// only the layout differs across designs. Renders inner content only (no
// DesignShell — the dispatcher wraps it).
export default function ActivityDetailShared() {

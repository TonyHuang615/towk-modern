...
// Classic body + shared fallback. Identical content/data/form to every other
// Contact body; only the layout differs across designs.
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export default function ContactShared({ content }: { content: Record<string, any> }) {
  void content;

...
// Classic body + shared fallback. Identical content/data to every other History
// body; only the layout differs across designs. History is purely i18n-driven, so
// `content` is accepted for signature parity but not consumed here.
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export default function HistoryShared({ content }: { content: Record<string, any> }) {
